(function (root, factory) {
    ...
    module.donut = function () {
        ...
        this.render = function (data, target, w, h, options) {
            ...
            //ir = width / 6;
            var ir = 0;
            if (options.ir >= 0) ir = options.ir; else ir = width / 6;
            ...
            tooltipBuilder = donut_defaultTooltip(function (d) {
                return d.data.label;
            }, function (d) {
    ...
    module.barchart = function () {
        this.render = function (data, target, w, h, options) {
            var defaults = {
                ...
                labelFontSize: '15px',
                textFontSize: '15px',
                barPaddingFactor: 1.0,
                left: 60,
                yLable: 'Frequency',
                bottom: 25  // default for no rotation
            };
            ...
            var x = d3.scale.ordinal()
                //.rangeRoundBands([0, width], (1.0 / data.length));
                .rangeRoundBands([0, width], (options.barPaddingFactor / data.length));
            ...
            svg.append("g")
                ...
                .attr("transform", function (d) {
                    ...
                    //return "translate(" + this.getBBox().height*(-0.0) + "," + this.getBBox().height + ") rotate(" + options.rotate + ")";
                })
